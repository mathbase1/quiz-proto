...
export { TOPICS as BANK_TOPICS, makeRng, cryptoSeed };
...
export function generateQuestion({topicCode, marksTotal, paperMode, seed, instanceId}){
...
export function renderQuestionHTML(q, opts={}){
...
export function markQuestion(container, question){
...
export function getAnswerList(question){
